...
// @version    0.1
// @description  Active Analytics Master's Thesis
// @include    http://www.unf.edu*
// @copyright  2014+, Will Carle
// @require http://active-analytics.appspot.com/client/lib/jquery.tooltipster.min.js
// ==/UserScript==


$(document).ready(function(){
    $("head").append("<link href='http://active-analytics.appspot.com/client/lib/tooltipster.css' rel='stylesheet' />")
    $.getScript( "http://active-analytics.appspot.com/client/lib/jquery.tooltipster.min.js", function( data, textStatus, jqxhr ) {setTimeout(init, 1000)});
});
